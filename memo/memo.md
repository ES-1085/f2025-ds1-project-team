...
<img src="memo_files/figure-gfm/plot-1-1.png" alt="Vertical bar chart showing total annual energy usage (in mmBTUs) for five NYC boroughs: Manhattan, Bronx, Brooklyn, Queens, and Staten Island. Manhattan has the highest total usage, followed by the Bronx and Brooklyn, while Queens and Staten Island are much lower."  />
...
<img src="memo_files/figure-gfm/plot-2-1.png" alt="Vertical bar chart showing energy usage per student (in mmBTUs) across Manhattan, Staten Island, Bronx, Brooklyn, and Queens. Manhattan and Staten Island have the highest per-student usage, the Bronx and Brooklyn fall in the middle, and Queens has the lowest."  />
...
<img src="memo_files/figure-gfm/plot-4-1.png" alt="Vertical bar chart displaying median household income for Manhattan, Staten Island, Brooklyn, Queens, and the Bronx. Manhattan has the highest income by a wide margin, Staten Island is next, Brooklyn and Queens fall in the middle, and the Bronx is lowest."  />
...
<img src="memo_files/figure-gfm/plot-5-1.png" alt="Vertical bar chart showing estimated annual carbon emissions (in metric tons of CO₂) from school buildings across Manhattan, Bronx, Brooklyn, Queens, and Staten Island. Manhattan has the highest total emissions, followed by the Bronx and Brooklyn, while Queens and Staten Island have the lowest."  />
